...
% Gap in knowledge
Despite much excellent experimental and theoretical work, there is no quantitative evidence in selective facet adsorption of structure-directing agents and their influence in shape control.
% Urgency
Yet, without such an understanding, we are left with an incomplete description of the mechanism that creates the condition for ill-informed reaction engineering for scale-up.
...
% Hero narrative
This study will remedy this gap in the literature by examining the kinetics and the thermodynamics of the solution-phase nanocrystals synthesis in order to more fully elucidate the shape control mechanism.

using molecular dynamics simulation, in which explicit solvent is computationally feasible and observations in the atomic resolution can be made.
