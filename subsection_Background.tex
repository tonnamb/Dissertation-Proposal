...
The growth of nanocrystals can be roughly divided into three stages:
1) nucleation;
2) evolution of nuclei into seeds;
3) growth of seeds into nanocrystals.
Our current understanding of the evolution pathway is far from being able to visualize the atomistic details of how seeds nucleate and evolve into nanocrystals of specific shape.
